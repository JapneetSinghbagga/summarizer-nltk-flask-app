...
def original_text_form():
	...
	print (summary)
	return render_template("sumup.html", title = title, original_text = text, output_summary = summary, num_sentences = max_value)
@app.route('/')

def sumup():
	title = "Text Summarizer"
	return render_template("sumup.html", title = title)
